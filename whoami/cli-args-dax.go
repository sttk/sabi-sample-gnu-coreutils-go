...
func (dax CliArgsDax) PrintHelp() {
	...
	help.AddText("Usage: whoami [OPTION]...", 7, 0)
	help.AddText(`Print the user name associated with the current effective user ID.
Same as id -un.
`)
	help.AddOpts(optCfgs, 14, 6)
	help.AddText("")
	help.Print()
}
